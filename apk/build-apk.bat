...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Copy-Item '%~dp0..\wp2026.html' '%~dp0www\index.html' -Force; Copy-Item '%~dp0..\css\wp2026.css' '%~dp0www\css\' -Force; Copy-Item '%~dp0..\js\data.js','%~dp0..\js\util.js','%~dp0..\js\api.js','%~dp0..\js\wp2026-app.js' '%~dp0www\js\' -Force; if (Test-Path '%~dp0..\lib') { Copy-Item '%~dp0..\lib\*' '%~dp0www\lib\' -Force -Recurse }" >> "%LOG%" 2>&1
