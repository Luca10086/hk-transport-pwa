...
object CrashLog {
    ...
    private fun write(ctx: Context, thread: String, e: Throwable) {
        ...
        val body = buildString {
            ...
            val code = if (pkg == null) 0L else if (Build.VERSION.SDK_INT >= 28) pkg.longVersionCode else pkg.versionCode.toLong()
            appendLine("App：${ctx.packageName} ${pkg?.versionName ?: "?"}($code)")
